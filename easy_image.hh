...
namespace img
{
	...
	class Color
	{
		...
		public:
             ...
             * \brief Constructs a Color with the given intensities
             *
             * \param vec the RGB color components
             * */
			Color(std::vector<int> vec);
	...
	class EasyImage
	{
		public:
            ...
            /**
             * \brief Fills the image with a background of a gradient of two specified colors. Defaults to black
             *
             * \param color1	The color to be assigned to the bottom left pixel
             * \param color2    The color to be assigned to the top right pixel
             */
            void clear_gradient(Color color1 = Color(), Color color2 = Color());
			...
			void draw_line_rainbow(unsigned int x0, unsigned int y0, unsigned int x1, unsigned int y1);
